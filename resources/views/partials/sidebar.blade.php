<aside id="logo-sidebar"
    ...
    aria-label="Sidebar">
    <div class="h-full pl-8 pb-4 overflow-y-auto bg-white">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-[#C3E9FF] group">
                    ...
                    <span class="flex-1 ms-4 poppins-regular text-xl">Users</span>
                </a>
            </li>
