    ...
    <div class="space-y-2">
        <div class="flex justify-between space-x-2">
            <div class="flex justify-start">
                ...
                <button data-modal-target="modal-add-document" data-modal-toggle="modal-add-document" type="button"
                    class="px-10 bg-slate-300 rounded-lg">
                    Tambah Document
            ...
            <div class="flex justify-center items-center">
                ...
                <form action="{{ route('document.index') }}" method="GET" class="flex items-center max-w-sm mx-auto">
                    <input type="text" name="search" value="{{ request('search') }}"
                        placeholder="Cari berdasarkan ID atau Nama..."
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">

                    <button type="submit"
                        class="p-2.5 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
